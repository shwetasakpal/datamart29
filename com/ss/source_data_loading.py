...
import yaml
import os.path
from com.ss.utils import aws_utils as ut
...
if __name__ == '__main__':
    ...
    for src in src_list:
        ...
        if src == 'SB':
            txn_df = ut.read_from_my_sql(spark,
...
# spark-submit --packages "org.mongodb.spark:mongo-spark-connector_2.11:2.4.1,mysql:mysql-connector-java:8.0.15,com.springml:spark-sftp_2.11:1.1.1,org.apache.hadoop:hadoop-aws:2.7.4" com/ss/source_data_loading.py

# spark-submit --packages "org.mongodb.spark:mongo-spark-connector_2.11:2.2.2,org.apache.hadoop:hadoop-aws:2.7.4" com/ss/source_data_loading.py
